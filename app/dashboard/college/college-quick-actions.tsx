    ...
    <>
      ...
      <div className="fixed bottom-6 end-6 z-[88] flex flex-col items-start gap-2" dir="rtl">
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className="flex size-12 items-center justify-center rounded-full bg-[#1E3A8A] text-white shadow-lg shadow-[#1E3A8A]/35 ring-[3px] ring-white transition hover:bg-[#172554] focus:outline-none focus-visible:ring-4 focus-visible:ring-amber-400/50"
        >
          {open ? (
